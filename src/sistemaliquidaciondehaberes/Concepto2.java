...
/** * Ariel Marcelo Diaz****/
public class Concepto2 extends libSentenciasSQL 
{ 
    
    // crea un nuevo concepto para aplicarlo 
    class Detalle2 extends libSentenciasSQL 
    {
        int idConcepto = 0;
        String nombreCons = "";
        String detalleCons = "";
    ...
    class Aplica2 extends Concepto 
    {
        int idRecibo = 0;
        int idConcepto = 0;
        float valor = 0;
    ...
    class Control2 extends libSentenciasSQL    
    {
        int idLegajo=0;
        int idConcepto=0;
        float unidades = 0;
